...
func (m RootModel) View() string {
	...
	// Re-join with updated footer
	// Wait, m.footer is NOT a pointer here. m.footer.SetHelp modifies LOCAL copy of footer in m.
	// So m.footer.View() below uses the modified footer.
	// This is correct.
